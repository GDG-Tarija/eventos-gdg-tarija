...
export class SPSponsor {
  private supabase: SupabaseClient;
  private data$ = new BehaviorSubject<Sponsor[]>([]);
  private listening = false;

  private readonly TABLE_NAME = 'sponsors';

  constructor() {
    this.supabase = createClient(environment.supabaseUrl, environment.supabaseKey);
  }

  public get(): Observable<Sponsor[]> {
  ...
  public add(item: Sponsor): Observable<Sponsor[]> {
  ...
  public update(item: Sponsor): Observable<Sponsor[]> {
  ...
  public delete(id: string): Observable<Sponsor[]> {
    return from(
  ...
  public listen(): Observable<Sponsor[]> {
